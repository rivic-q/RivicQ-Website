...
export const useCases: UseCase[] = [
  ...
  { title: 'Code Signing & CI/CD', summary: 'ML-DSA-65 signatures for software artifacts. Post-quantum trust in your supply chain, with HSM-backed key rotation policies and CSPM/QBOM verification.', rq: 'CSPM Scanner + SDK + CloudHSM' },
  { title: 'Regulatory Compliance', summary: 'Automated CSPM and QBOM generation for DORA/NIS2/NIST audits. Encryption posture analysis, gap assessment, remediation planning with Q-score prioritization.', rq: 'CSPM Scanner + QBOM' },
